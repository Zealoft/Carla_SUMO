...
class Waypoint(object):
    ...
    def __init__(self):
        self.Location = [ 0.0 for dim0 in range(3) ]
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack('>3d', *self.Location[:3]))
        buf.write(struct.pack('>3d', *self.Rotation[:3]))
    ...
    def _decode_one(buf):
        self = Waypoint()
        self.Location = struct.unpack('>3d', buf.read(24))
        self.Rotation = struct.unpack('>3d', buf.read(24))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xce465307bf1d8727) & 0xffffffffffffffff
