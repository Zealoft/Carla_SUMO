...
class action_package(object):
    ...
    __dimensions__ = [None, [10], [3]]

    def __init__(self):
        self.vehicle_id = ""
        self.waypoints = [ npc_control.Waypoint() for dim0 in range(10) ]
        self.target_speed = [ 0.0 for dim0 in range(3) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(b"\0")
        for i0 in range(10):
            assert self.waypoints[i0]._get_packed_fingerprint() == npc_control.Waypoint._get_packed_fingerprint()
            self.waypoints[i0]._encode_one(buf)
        buf.write(struct.pack('>3d', *self.target_speed[:3]))
    ...
    def _decode_one(buf):
        ...
        self.waypoints = []
        for i0 in range(10):
            self.waypoints.append(npc_control.Waypoint._decode_one(buf))
        self.target_speed = struct.unpack('>3d', buf.read(24))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x7681d8206bff4554+ npc_control.Waypoint._get_hash_recursive(newparents)) & 0xffffffffffffffff
