...
# ==============================================================================
try:
    sys.path.append(glob.glob('PythonAPI/carla-*%d.%d-%s.egg' % (
        sys.version_info.major,
        sys.version_info.minor,
        'win-amd64' if os.name == 'nt' else 'linux-x86_64'))[0])
    sys.path.append(glob.glob('CarlaClient/PythonAPI/carla-*%d.%d-%s.egg' % (
        sys.version_info.major,
        sys.version_info.minor,
        'win-amd64' if os.name == 'nt' else 'linux-x86_64'))[0])
...
class World(object):
    ...
    def restart(self):
        ...
        blueprint = random.choice(self.world.get_blueprint_library().filter("vehicle.physx.*"))
